...
void export_blueprint() {
  ...
  class_<cc::ActorAttribute>("ActorAttribute", no_init)
    ...
    .def("as_bool", +[](cc::ActorAttribute& val){return val.As<bool>();})
    .def("as_int", +[](cc::ActorAttribute& val){return val.As<int>();})
    .def("as_float", +[](cc::ActorAttribute& val){return val.As<float>();})
    .def("as_str", +[](cc::ActorAttribute& val){return val.As<std::string>();})
    .def("as_color", +[](cc::ActorAttribute& val){return val.As<csd::Color>();})
    .def("__eq__", +[](cc::ActorAttribute& val, bool b) {return val == b;})
    .def("__eq__", +[](cc::ActorAttribute& val, int b) {return val == b;})
    .def("__eq__", +[](cc::ActorAttribute& val, float b) {return val == b;})
    .def("__eq__", +[](cc::ActorAttribute& val, std::string b) {return val == b;})
    .def("__eq__", +[](cc::ActorAttribute& val, csd::Color b) {return val == b;})
    .def("__eq__", +[](cc::ActorAttribute& val, cc::ActorAttribute b) {return val == b;})
    .def("__ne__", +[](cc::ActorAttribute& val, bool b) {return val != b;})
    .def("__ne__", +[](cc::ActorAttribute& val, int b) {return val != b;})
    .def("__ne__", +[](cc::ActorAttribute& val, float b) {return val != b;})
    .def("__ne__", +[](cc::ActorAttribute& val, std::string b) {return val != b;})
    .def("__ne__", +[](cc::ActorAttribute& val, csd::Color b) {return val != b;})
    .def("__ne__", +[](cc::ActorAttribute& val, cc::ActorAttribute b) {return val != b;})
    .def("__nonzero__", +[](cc::ActorAttribute& val){return val.As<bool>();})
    .def("__bool__", +[](cc::ActorAttribute& val){return val.As<bool>();})
    .def("__int__", +[](cc::ActorAttribute& val){return val.As<int>();})
    .def("__float__", +[](cc::ActorAttribute& val){return val.As<float>();})
    .def("__str__", +[](cc::ActorAttribute& val){return val.As<std::string>();})
    .def(self_ns::str(self_ns::self))
  ;
